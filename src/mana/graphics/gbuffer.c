...
int gbuffer_init(struct GBuffer* gbuffer, struct VulkanRenderer* vulkan_renderer) {
  ...
  vulkan_renderer->gbuffer->color_image_view = graphics_utils_create_image_view(vulkan_renderer->device, gbuffer->color_image, VK_FORMAT_A2B10G10R10_UNORM_PACK32, VK_IMAGE_ASPECT_COLOR_BIT);
  ...
  vulkan_renderer->gbuffer->normal_image_view = graphics_utils_create_image_view(vulkan_renderer->device, gbuffer->normal_image, VK_FORMAT_A2B10G10R10_UNORM_PACK32, VK_IMAGE_ASPECT_COLOR_BIT);
  ...
  vulkan_renderer->gbuffer->depth_image_view = graphics_utils_create_image_view(vulkan_renderer->device, gbuffer->depth_image, depth_format, VK_IMAGE_ASPECT_DEPTH_BIT);
