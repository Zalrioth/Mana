...
private:
    ...
    void loadModel(string const& path)
    {
        ...
        // scene->mRootNode->mTransformation.b3 = 0;
        // scene->mRootNode->mTransformation.b2 = 1;
        // scene->mRootNode->mTransformation.c2 = 0;
        // scene->mRootNode->mTransformation.c3 = 1;

        // float tmp = scene->mRootNode->mTransformation.d1;
        // scene->mRootNode->mTransformation.d1 =
        // scene->mRootNode->mTransformation.d2;
        // scene->mRootNode->mTransformation.d2 = -tmp;
        ...
        // scene->mRootNode->mTransformation;//glm::rotate(glm::mat4(1.0f), -90.0f,
        // glm::vec3(1.0f, 0.0f, 0.0f));// *scene->mRootNode->mTransformation;
        rootMatrix = scene->mRootNode->mTransformation;
    ...
    void processNode(aiNode* node, const aiScene* scene)
    {
        ...
        for (unsigned int i = 0; i < node->mNumChildren; i++) {
            // node->mChildren[i]->mTransformation = aiMatrix4x4();
