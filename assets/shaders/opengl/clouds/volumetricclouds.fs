...
//https://raw.githubusercontent.com/fede-vaccaro/TerrainEngine-OpenGL/master/shaders/volumetric_clouds.frag
//https://www.youtube.com/watch?v=7pzGvCk_VfM
...
void main()
{
	...
	//fragColor = vec4(vec3(texture(worley32, vec3(TexCoords, 10)).r), 1.0);
	//fragColor = vec4(vec3(texture(cloud, vec3(TexCoords, 20)).r), 1.0);
	//fragColor = vec4(vec3(texture(weatherTex, TexCoords).r), 1.0);
