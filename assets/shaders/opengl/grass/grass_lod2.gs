#version 410 core
//https://github.com/lragnarsson/Emerald-Engine/blob/master/src/shaders/grass_lod2.geom
...
void main()
{
    ...
    vec3 center_triangle = gs_in[0].FragPos + 0.5 * frag_pos_base_01 + 0.5 * frag_pos_02 + MAGNITUDE * GRASS_SCALE * GRASS_2_Y[4] * normal;
